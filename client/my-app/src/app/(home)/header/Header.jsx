    ...
    <Fragment>
      <header className={clsx(style.header)}>
        <div className={clsx(style.main)}>
          <div
            className={clsx("flex", "items-center", "justify-between", "mb-3")}
          >
            <ul className={clsx("flex", "items-center", "justify-center")}>
              <li className={clsx(style["contact-item"])}>Kênh người bán</li>
              <li className={clsx(style["contact-item"])}>Tải ứng dụng</li>
              <li className={clsx(style["contact-item"])}>Kết nối</li>
            </ul>
