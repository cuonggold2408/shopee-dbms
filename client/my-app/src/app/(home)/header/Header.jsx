      ...
      <header className={clsx(style.header)}>
        <div className={clsx()} >
          <div className={clsx(style.container, "flex justify-between items-center")}>
            <div className={clsx("flex", "items-center", "justify-between gap-2 p-2")}>
              <div className={clsx(style["contact-item"])}>Kênh người bán</div>
              <div className={clsx(style["contact-item"])}>Tải ứng dụng</div>
              <div className={clsx(style["contact-item"])}>Kết nối</div>
            </div>
          ...
          {(pathname !== '/cart' && pathname !== '/checkout') ? (
                    ...
                    {cart.map((item, index) => (
                      <div key={index} className="flex justify-between p-2 mb-2">
                        <div
                          ...
                          className={clsx(style["content-product"], "flex")}
                        >
                          <Image
                          ...
                          <div style={{ width: "80%" }}>
                            ...
                            <div className={clsx(style["price-product"])}>
            ...
            (pathname === '/cart') ? (
              <div className={clsx('bg-white flex items-center', style.box__search)}>
                <div className={clsx(style.container, "flex items-center justify-between")}>
