        ...
        <Fragment>
            ...
            <div className={styles.main}>
                <div className={styles.container}>
                    <div className={clsx("flex items-center gap-1 p-2 mt-5", styles.box__freeship)}>
                    ...
                    <div className={clsx(styles.box__cart)}>
                        ...
                        <div className={clsx(styles.cart__title, 'flex items-center px-5 py-3 mt-3')}>
                            ...
                            <div className={clsx(styles.title__quantity, "flex justify-center")}>
                                Số lượng
                            </div>
                        ...
                        <div className={clsx(styles.list__product)}>
                            {/* Đổ product */}
                            <div className={clsx(styles.product__item, 'flex items-center py-5 px-5 mt-3')}>
                                <div className={clsx(styles.checkbox, "flex items-center gap-2")}>
                                    <input type="checkbox" />
                                    <Image src={TestCart} alt="test-cart" width={80} height={80} />
                                    <p className={clsx(styles.title__product)}>Dép bánh mì nam nữ Sách - Nihongo Somatome - Luyện thi năng lực Nhật ngữ N4 - Ngữ pháp, Đọc hiểu, Nghe hiểu</p>
                                    <div style={
                                        {
                                ...
                                <div className={clsx(styles.unit__price, "flex justify-center")}>
                                    <div className="flex items-center justify-center gap-3">
                                        ...
                                        <div className={clsx(styles.price__new)}>₫59.000</div>
                                    </div>
                                </div>
                                <div className={clsx(styles.title__quantity, "flex justify-center")}>
                            ...
                            <div className={clsx(styles.product__item, 'flex items-center py-5 px-5 mt-3')}>
                                <div className={clsx(styles.checkbox, "flex items-center gap-2")}>
                                    <input type="checkbox" />
                                    <Image src={TestCart} alt="test-cart" width={80} height={80} />
                                    <p className={clsx(styles.title__product)}>Dép bánh mì nam nữ</p>
                            ...
                            <div className={clsx('flex items-center justify-between bg-white mt-5 p-5')}>
