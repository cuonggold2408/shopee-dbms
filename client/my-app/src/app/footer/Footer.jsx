        ...
        >
          <div className="flex gap-10 justify-between">
            ...
            >
              <h2 className={clsx(style.title)}>
                Tải ứng dụng Shopee ngay thôi nào
              </h2>
          ...
          >
            ...
            >
              ...
              <ul className="flex justify-between">
                <li
                  className={clsx(style["text-footer"], style["country-item"])}
                >
                  Singapore
                </li>
                <li
          ...
          >
            <ul className="flex justify-center items-center">
              <li className={clsx("p-3", style["security-item"])}>
                Chính sách bảo mật
              </li>
              <li className={clsx("p-3", style["security-item"])}>
                Quy chế hoạt động
